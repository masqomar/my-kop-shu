...
@section('title', __('Setor Simpanan'))
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-navy">
                        <h3 class="card-title"><b style="font-size: 30px" class="mr-1">S</b>ETOR SIMPANAN ANGGOTA </h3><br>
                        <hr class="mt-3 mb-0" style="border: 1px solid #fff">
                    </div>
                    <form action="{{ route('admin.setor-simpanan.store') }}" method="POST">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>{{ __('Jumlah Simpanan') }}</label>
                                <input type="number" name="jumlah_simpanan" id="jumlah_simpanan" class="form-control @error('jumlah_simpanan') is-invalid @enderror" required />
